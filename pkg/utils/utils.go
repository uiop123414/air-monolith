...
func WriteJSON(w http.ResponseWriter, status int, headers ...http.Header) error {
...
func ReadJSON(w http.ResponseWriter, r *http.Request, loader gojsonschema.JSONLoader, data interface{}) error {
	...
	err = ValidateJSON(loader, bodyBytes)
	if err != nil {
		return err
	}
...
func ErrorJSON(w http.ResponseWriter, status ...int) error {
